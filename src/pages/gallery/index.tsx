  ...
  return (
    <>
      ...
      <div className="grid gap-4 p-6">
        {[
          ["/Linh-20.jpg", "/Linh-19.jpg"],
          ["/Linh-6.jpg", "/Linh-27.jpg", "/Linh-15.jpg"],
          ["/Linh-17.jpg", "/Linh-18.jpg"],
          ["/Linh-34.jpg", "/Linh-14.jpg", "/Linh-8.jpg"],
          ["/Linh-33.jpg", "/Linh-26.jpg"],
        ].map((row, index) => (
          <div
            key={index}
            className={`grid grid-cols-1 sm:grid-cols-${row.length === 2 ? "2" : "3"} gap-4 fade-in-up opacity-0`}
          >
            {row.map((src, idx) => (
