  ...
  return (
    ...
    <div className="flex flex-col md:flex-row h-screen">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-6">
          <p className="text-xl avenir animate-slideFromTop">Join us in the Celebration of</p>
          <h1 className="p-8 text-5xl md:text-9xl didot italic  text-[#383B42] uppercase text-center animate-slideFromBottom">Jack
    ...
    {/* Home RSVP */}
    <div id="rsvp" className="flex flex-col md:flex-row space-y-10 md:space-y-0 md:h-screen p-8 md:p-12 gap-5">
    ...
    <div className="flex flex-col justify-center items-center py-32">
      <p className="fraunces text-2xl lg:text-4xl lg:w-1/2 px-16 font-semibold text-[#383B42] text-center animate-fadeIn">“And now here is my secret, a very simple secret: It is only with the heart that one can see rightly; what is essential is invisible to the eye."</p>
      <p className="avenir text-md pt-4 animate-fadeIn">Antoine de Saint-Exupéry</p>
    </div>
        ...
        <div className="grid grid-cols-12 gap-4 h-full">
          ...
          <div className="col-span-4 relative">
            ...
            <div className="bg-white justify-center absolute flex flex-col inset-y-16 -mx-10 px-16">
                <h3 className="text-5xl mb-4 didot font-bold text-right">Our Love Story</h3>
                ...
                When the time was right, they took the leap, trading cobblestone for skyscrapers, and Boston’s charm for New York’s endless rhythm. Amidst the urban sprawl, they found solace in each other's presence. Their love, quiet and steadfast, blossomed in the simplicity of shared routines and whispered promises under the city lights.
                </p>
                <p className="mt-4 text-[#383B42] avenir">
                In the grandeur of the mundane, Jack and Linh carved out a world that was theirs alone. Not defined by grand gestures, but by the quiet strength found in everyday moments. Their love story, a tapestry of gentle touches and understanding glances, continues to unfold, a beautiful narrative of life's simplest yet most profound joys.
                </p>
            </div>
          </div>
    ...
    <div id="registry" className="h-screen parallax-full bg-gradient-to-r flex items-center justify-center pt-50"
    style={{
